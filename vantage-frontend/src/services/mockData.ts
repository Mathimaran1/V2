...
const mockTickets: JiraTicket[] = [
  {
    ...
    project: 'AI-Dev-Observability', sprint: 'Sprint 14', labels: ['auth', 'sso', 'security'],
  ...
  },
  {
    ...
    priority: { name: 'High', level: 'high' },
    issueType: { name: 'Story', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 14', labels: ['data-quality'],
  ...
  },
  {
    ...
    project: 'AI-Dev-Observability', sprint: 'Sprint 14', labels: ['refactor'],
  ...
  },
  {
    ...
    project: 'AI-Dev-Observability', sprint: 'Sprint 14', labels: ['monitoring', 'alerts'],
  ...
  },
  {
    ...
    issueType: { name: 'Task', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 14', labels: ['dependencies'],
  ...
  },
  {
    ...
    priority: { name: 'Medium', level: 'medium' },
    issueType: { name: 'Story', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 13', labels: ['ci-cd'],
  ...
  },
  {
    ...
    priority: { name: 'Low', level: 'low' },
    issueType: { name: 'Task', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 13', labels: ['testing'],
  ...
  },
  {
    ...
    priority: { name: 'Medium', level: 'medium' },
    issueType: { name: 'Story', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 13', labels: ['quality', 'sonarqube'],
  ...
  },
  {
    ...
    priority: { name: 'Low', level: 'low' },
    issueType: { name: 'Story', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 15', labels: ['ml', 'data'],
  ...
  },
  {
    ...
    priority: { name: 'High', level: 'high' },
    issueType: { name: 'Story', iconUrl: '' },
    project: 'AI-Dev-Observability', sprint: 'Sprint 15', labels: ['dashboard', 'ml'],
...
const mockCommits: Commit[] = [
  {
    ...
    timestamp: '2025-05-17T13:30:00Z', repositoryName: 'ai-dev-observability/auth-service',
  ...
  },
  {
    ...
    timestamp: '2025-05-17T11:00:00Z', repositoryName: 'ai-dev-observability/auth-service',
  ...
  },
  {
    ...
    timestamp: '2025-05-17T07:00:00Z', repositoryName: 'ai-dev-observability/auth-service',
  ...
  },
  {
    ...
    timestamp: '2025-05-16T10:00:00Z', repositoryName: 'ai-dev-observability/auth-service',
  ...
  },
  {
    ...
    timestamp: '2025-05-15T14:00:00Z', repositoryName: 'ai-dev-observability/auth-service',
  ...
  },
  {
    ...
    timestamp: '2025-05-14T09:00:00Z', repositoryName: 'ai-dev-observability/auth-service',
  ...
  },
  {
    ...
    timestamp: '2025-05-14T08:00:00Z', repositoryName: 'ai-dev-observability/auth-service',
...
const mockPullRequests: PullRequest[] = [
  {
    ...
    codeCommitUrl: 'https://us-east-1.console.aws.amazon.com/codesuite/codecommit/repositories/ai-dev-observability-auth/pull-requests/131',
  },
  {
    ...
    codeCommitUrl: 'https://us-east-1.console.aws.amazon.com/codesuite/codecommit/repositories/ai-dev-observability-auth/pull-requests/128',
  },
  {
    ...
    codeCommitUrl: 'https://us-east-1.console.aws.amazon.com/codesuite/codecommit/repositories/ai-dev-observability-auth/pull-requests/122',
  },
  {
    ...
    codeCommitUrl: 'https://us-east-1.console.aws.amazon.com/codesuite/codecommit/repositories/ai-dev-observability-auth/pull-requests/118',
  },
  {
    ...
    codeCommitUrl: 'https://us-east-1.console.aws.amazon.com/codesuite/codecommit/repositories/ai-dev-observability-auth/pull-requests/111',
  },
];
